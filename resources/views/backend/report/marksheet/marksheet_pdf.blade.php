                        ...
                        <div class="box-body ">
                            <div class="row">
                                <div class="col-md-6 text-center">
                                    <h1><strong>Thanh Learning School</strong></h1>

                                </div>
                                <div class="col-md-6 text-center">
                                    <h4><strong>Thanh Learning School</strong></h4>
                                    <h6><strong> Phu Loc, Thua Thien, Hue</strong></h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="8"
                                        ...
                                        @php
                                        $assign_student =
                                        App\Models\AssignStudent::where('year_id',$all_marks['0']->year_id)->where('class_id',$all_marks['0']->class_id)->first();
                                        @endphp
