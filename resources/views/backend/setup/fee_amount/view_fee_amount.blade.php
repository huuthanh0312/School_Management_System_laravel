                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href class="btn btn-round btn-success mb-10 float-right" data-toggle="modal"
                                data-target="#myModal">Add Fee Amount</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{$fee_amount['fee_category']['name'] }}</td>
                                            <td>
                                                <a href="{{route('fee.amount.edit', $fee_amount->fee_category_id)}}"
                                                    class="btn btn-round btn-info">Edit</a>
                                                <a href="{{route('fee.amount.details', $fee_amount->fee_category_id)}}"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Add Student Fee Amount</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <form action="{{route('fee.amount.store')}}" method="post" class="form-group">
                @csrf
