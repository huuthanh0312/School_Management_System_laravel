                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href class="btn btn-round btn-success mb-10 float-right" data-toggle="modal"
                                data-target="#myModal">Add Designation</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('designation.edit', $designation->id)}}" class="btn btn-round btn-info">Edit</a>
                                                <a href="{{route('designation.delete', $designation->id)}}" class="btn btn-round btn-danger" id="delete">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('designation.store')}}" method="post" class="form-group">
                @csrf
