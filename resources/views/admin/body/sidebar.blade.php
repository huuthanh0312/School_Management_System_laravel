    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ $prefix == '/profile' ? 'active': ''}}">
                <a href="#">
                    <i data-feather="user"></i> <span>Manager Profile</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{$route == 'profile.view' ? 'active' : ''}}"><a href="{{route('profile.view')}}"><i class="ti-more"></i>Profile</a></li>
            ...
            <li class="treeview {{ $prefix == '/setups' ? 'active': ''}}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{$route == 'school.subject.view' ? 'active' : ''}}"><a href="{{route('school.subject.view')}}"><i class="ti-more"></i>Shool Subject</a></li>
            ...
            <li class="treeview {{ $prefix == '/reports' ? 'active': ''}}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{$route == 'attend.report.view' ? 'active' : ''}}"><a href="{{route('attend.report.view')}}">
                        <i class="ti-more"></i>Attendance Report</a>
                    </li>
                    <li class="{{$route == 'student.result.view' ? 'active' : ''}}"><a href="{{route('student.result.view')}}">
                        <i class="ti-more"></i>Student Result</a>
                    </li>
                    <li class="{{$route == 'student.idcard.view' ? 'active' : ''}}"><a href="{{route('student.idcard.view')}}">
                        <i class="ti-more"></i>Student ID Card </a>
                    </li>
                </ul>
            </li>
        </ul>
